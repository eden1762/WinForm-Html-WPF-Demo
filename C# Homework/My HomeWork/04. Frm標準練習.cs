...
namespace My_HomeWork
{
    public partial class Frm標準練習 : Form
    {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            bool x = int.TryParse(NumbertextBox.Text, out a);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            int a;
            int b;
            bool x = int.TryParse(No1textBox.Text, out a);
            bool y = int.TryParse(No1textBox.Text, out b);
            Swap(ref a, ref b);
            No1textBox.Text = a.ToString();
            No2textBox.Text = b.ToString();  
